...
"""Power flow powerdata for IEEE 118 bus test case.
"""
...
def case118():
    """Power flow powerdata for IEEE 118 bus test case.
    Please see L{case format} for details on the case file format.

    This powerdata was converted from IEEE Common Data Format
    (ieee118cdf.txt) on 20-Sep-2004 by cdf2matp, rev. 1.11
    See end of file for warnings generated during conversion.

    Converted from IEEE CDF file from:
    U {https://www.ee.washington.edu/research/pstca/}

    With baseKV powerdata take from the PSAP format file from the same site,
    added manually on 10-Mar-2006.

    08/25/93 UW ARCHIVE 100.0  1961 W IEEE 118 Bus Test Case

    @return: Power flow powerdata for IEEE 118 bus test case.
    """
    ...
    ppc["bus"] = array([
        ...
        [5, 1, 5, 0, 0, -40, 1, 1.002, 15.73, 138, 1, 1.06, 0.94],
        ...
        [9, 1, 6, 0, 0, 0, 1, 1.043, 28.02, 345, 1, 1.06, 0.94],
        [10, 2, 5, 0, 0, 0, 1, 1.05, 35.61, 345, 1, 1.06, 0.94],
        ...
        [25, 2, 8, 0, 0, 0, 1, 1.05, 27.93, 138, 1, 1.06, 0.94],
        [26, 2, 9, 0, 0, 0, 1, 1.015, 29.71, 345, 1, 1.06, 0.94],
        ...
        [30, 1, 10, 0, 0, 0, 1, 0.968, 18.79, 345, 1, 1.06, 0.94],
        ...
        [37, 1, 11, 0, 0, -25, 1, 0.992, 11.77, 138, 1, 1.06, 0.94],
        [38, 1, 14, 0, 0, 0, 1, 0.962, 16.91, 345, 1, 1.06, 0.94],
        ...
        [61, 2, 5, 0, 0, 0, 1, 0.995, 24.04, 138, 1, 1.06, 0.94],
        [62, 2, 77, 14, 0, 0, 1, 0.998, 23.43, 138, 1, 1.06, 0.94],
        [63, 1, 5, 0, 0, 0, 1, 0.969, 22.75, 345, 1, 1.06, 0.94],
        [64, 1, 5, 0, 0, 0, 1, 0.984, 24.52, 345, 1, 1.06, 0.94],
        [65, 2, 5, 0, 0, 0, 1, 1.005, 27.65, 345, 1, 1.06, 0.94],
        [66, 2, 39, 18, 0, 0, 1, 1.05, 27.48, 138, 1, 1.06, 0.94],
        [67, 1, 28, 7, 0, 0, 1, 1.02, 24.84, 138, 1, 1.06, 0.94],
        [68, 1, 9, 0, 0, 0, 1, 1.003, 27.55, 345, 1, 1.06, 0.94],
        [69, 3, 9, 0, 0, 0, 1, 1.035, 30, 138, 1, 1.06, 0.94],
        [70, 2, 66, 20, 0, 0, 1, 0.984, 22.58, 138, 1, 1.06, 0.94],
        [71, 1, 9, 0, 0, 0, 1, 0.987, 22.15, 138, 1, 1.06, 0.94],
        ...
        [81, 1, 8, 0, 0, 0, 1, 0.997, 28.1, 345, 1, 1.06, 0.94],
        ...
        [87, 2, 6, 0, 0, 0, 1, 1.015, 31.4, 161, 1, 1.06, 0.94],
        [88, 1, 48, 10, 0, 0, 1, 0.987, 35.64, 138, 1, 1.06, 0.94],
        [89, 2, 9, 0, 0, 0, 1, 1.005, 39.69, 138, 1, 1.06, 0.94],
        ...
        [111, 2, 5, 0, 0, 0, 1, 0.98, 19.74, 138, 1, 1.06, 0.94],
